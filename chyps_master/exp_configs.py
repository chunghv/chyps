...
EXP_GROUPS['kernel'] = ut.cartesian_exp_group({"dataset":kernel_datasets,
                                "model":["linear"],
...
EXP_GROUPS['mf'] = ut.cartesian_exp_group({"dataset":["matrix_fac"],
...
EXP_GROUPS['mnist'] = ut.cartesian_exp_group({"dataset":["mnist"],
                                "model":["mlp"],
...
EXP_GROUPS['deep'] = (ut.cartesian_exp_group({"dataset":["cifar10"],
                           ...
                           ut.cartesian_exp_group({"dataset":["cifar100"],
...
EXP_GROUPS['cifar'] = ut.cartesian_exp_group({"dataset":["cifar10"],
                                "model":["resnet34"],
                                "loss_func": ["softmax_loss"],
...
EXP_GROUPS['syn_l2'] = (ut.cartesian_exp_group({"dataset":['syn'],
                "model":["logistic"],
                "loss_func": [
                             'logistic_l2_loss', 
                             ],
...
EXP_GROUPS['syn'] = (ut.cartesian_exp_group({"dataset":['syn'],
                "model":["logistic"],
                "loss_func": [
                             'logistic_loss', 
                             ],
